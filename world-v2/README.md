...
- `kidscade-world-life-animation.js` : 실내 생활 행동
...
## 데이터 안전 원칙
현재 단계에서는 `kidscade_garden_v1`, 기존 Life World v1 저장값, 메인 씨앗 잔액을 수정하지 않습니다. World v2 자체 저장은 `kidscade_world_v2`만 사용합니다.

## 다음 단계
1. 작업 결과를 실제 인벤토리 / 체력 / 도구 내구도와 연결
2. 물건 들기 / 내려놓기 / 운반 애니메이션
3. 낚싯대 캐스팅 / 찌 / 당기기 애니메이션
4. 기존 v1 농사 시스템을 World v2 밭에 직접 이관
5. 벌목 / 채광 결과를 제작 시스템과 연결
