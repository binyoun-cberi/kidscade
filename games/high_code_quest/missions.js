...
const M=[
 ...
 {chapter:'시작 마을',concept:'순차 실행',title:'수정과 문',name:'3. 먼저 줍고, 그다음 열기',text:'수정을 지나치지 말고 그 자리에서 주운 뒤 문을 여세요. 순서를 바꾸면 실패해요.',objective:'수정 1개를 챙겨 문을 열고 출구로',length:10,start:1,goal:8,gaps:[],crystals:[3],doors:[{x:6,need:1}],enemies:[],memory:10,par:9,available:['FWD','COLLECT','OPEN'],unlock:'공격 명령',nextBlocks:['ATTACK']},
