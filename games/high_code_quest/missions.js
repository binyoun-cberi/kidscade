...
const M=[
 ...
 {chapter:'반복의 숲',concept:'반복문',title:'같은 행동이 계속돼',name:'5. 반복해서 돌파!',text:'같은 코드를 길게 복사하지 말고 반복 블록 안에 묶어 보세요.',objective:'버그 몬스터 3마리를 지나 출구로',length:15,start:1,goal:13,gaps:[],crystals:[],doors:[],enemies:[{x:4,type:'mush',hp:1},{x:8,type:'mush',hp:1},{x:12,type:'mush',hp:1}],memory:8,par:5,available:['FWD','ATTACK','REP2','REP3','REP4'],unlock:'적 감지 조건',nextBlocks:['IF_ENEMY']},
 {chapter:'센서 계곡',concept:'조건문',title:'있을 때만 공격',name:'6. 적을 보고 판단해',text:'몬스터 위치가 달라져도 작동하는 코드를 만들어 보세요. 적이 앞에 있을 때만 공격하면 됩니다.',objective:'조건을 사용해 어떤 배치에서도 통과',length:12,start:1,goal:10,gaps:[],crystals:[],doors:[],enemies:[{x:4,type:'blob',hp:1},{x:8,type:'blob',hp:1}],variants:[[4,8],[3,8],[5,7]],memory:9,par:5,available:['FWD','ATTACK','REP4','IF_ENEMY'],requireType:'IF_ENEMY',unlock:'낭떠러지 감지 조건',nextBlocks:['IF_GAP','JUMP']},
 {chapter:'센서 계곡',concept:'조건문',title:'길을 읽고 달리기',name:'7. 떨어지기 전에 점프!',text:'구덩이 위치를 외우지 말고 센서로 판단하세요. 앞이 비어 있을 때만 점프합니다.',objective:'낭떠러지 조건을 사용해 출구로',length:14,start:1,goal:12,gaps:[5,9],crystals:[],doors:[],enemies:[],memory:9,par:5,available:['FWD','JUMP','REP4','IF_GAP'],requireType:'IF_GAP',unlock:'수정 변수 조건',nextBlocks:['IF_CRYSTALS3']},
 {chapter:'기억의 광산',concept:'변수와 조건',title:'수정 = ?',name:'8. 세 개를 모으면 열려',text:'수정을 주울 때마다 수정 값이 1씩 올라가요. 3개가 되었을 때 문을 여세요.',objective:'수정 3개를 모아 문을 열고 출구로',length:13,start:1,goal:11,gaps:[],crystals:[3,5,7],doors:[{x:9,need:3}],enemies:[],memory:12,par:8,available:['FWD','COLLECT','OPEN','REP3','IF_CRYSTALS3'],requireType:'IF_CRYSTALS3',unlock:'나의 함수',nextBlocks:['CALL_FN']},
 ...
 {chapter:'버그의 탑',concept:'종합',title:'버그 골렘',name:'10. 배운 걸 전부 써!',text:'달리고, 줍고, 판단하고, 싸우세요. 지금까지 배운 코딩 개념을 전부 이용하는 마지막 스테이지입니다.',objective:'수정 3개 → 문 열기 → 골렘 격파 → 출구',length:18,start:1,goal:16,gaps:[6],crystals:[3,4,5],doors:[{x:10,need:3}],enemies:[{x:14,type:'golem',hp:3}],memory:20,par:13,functionMemory:8,available:Object.keys(A),requireType:'IF_CRYSTALS3',unlock:'코드 원정대 완주!',nextBlocks:[]}
];
