...
const ui=new DC.UI({
 start(tutorial){sim.start({tutorial});ui.startDone();sfx('collect.coin_pickup',{volume:.24,cooldownMs:100});},
 ...
 reward(id){if(sim.acceptReward(id))sfx('shop.purchase',{volume:.24,cooldownMs:120})}
});
