...
'.q17-mobile-controls{display:none;padding:8px;background:#0b0f13;border-top:1px solid #313a43;gap:8px;grid-template-columns:1fr 1.45fr}.q17-mobile-pad,.q17-mobile-actions{display:grid;gap:7px}.q17-mobile-pad{grid-template-columns:1fr 1fr}.q17-mobile-actions{grid-template-columns:repeat(2,1fr)}.q17-mobile-controls button{min-height:48px;border:1px solid #59636e;background:#202830;color:#f2f5f7;font-weight:950;border-radius:8px;touch-action:none;user-select:none;-webkit-user-select:none}.q17-mobile-controls button:active,.q17-mobile-controls button.active{transform:translateY(1px);background:#36424d}.q17-mobile-controls .shoot{background:#8e3035;border-color:#d85f66}.q17-mobile-controls .jump{background:#314f68}.q17-mobile-controls .melee{background:#59472c}.q17-mobile-controls .reload{background:#3b4147;font-size:11px}',
