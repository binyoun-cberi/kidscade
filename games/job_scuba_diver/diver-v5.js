...
function bind(){
 ...
 $('actionMain').onclick=useTool;$('interactMain').onclick=interact;$('dashMain').onpointerdown=()=>touch.dash=true;$('dashMain').onpointerup=$('dashMain').onpointercancel=()=>touch.dash=false;
