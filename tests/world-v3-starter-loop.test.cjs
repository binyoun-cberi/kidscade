...
test('starter loop is current cached Seed World v34',()=>{
  assert.match(html,/kidscade-world-v3\.js\?v=34/);
  assert.match(integration,/world-v3\/kidscade-world\.html\?v=34/);
});
