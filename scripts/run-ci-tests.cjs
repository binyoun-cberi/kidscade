...
const TEST_FILES = [
  ...
  "tests/game-classification.test.cjs","tests/catalog-metadata.test.cjs","tests/catalog-discovery.test.cjs","tests/game-sdk.test.cjs","tests/game-sdk-adoption.test.cjs","tests/source-owned-integrations.test.cjs",
