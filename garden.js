...
document.write('<script src="avatar-integration.js?v=avatar-preview-inline-edit-v4"><\/script>');
...
document.write('<script src="life-world-integration.js?v=world-v3-homebase-v25"><\/script>');
